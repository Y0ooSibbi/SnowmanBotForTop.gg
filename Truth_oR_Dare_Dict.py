...
Truth =["Did you ever drink before you were of the legal drinking age?" ,"What is the craziest thing you have done while under the influence?",
...
TorD= ["Truth: Tell me about the last time you got really embarrassed."
...
dare = ["Let the group choose an item for you to brush your teeth with.",
...
t1 = random.randint(0,len(Truth))
d1 = random.randint(0,len(dare))
td = random.randint(0,len(TorD))
def truth_q():
    return Truth[t1]


def dare_q(): return dare[d1]
def td_q(): return TorD[td]